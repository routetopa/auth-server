...
if ('D:\Luca\Documents\Route to PA\routetopa-openid\inc\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('D:\Luca\Documents\Route to PA\routetopa-openid\inc\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
