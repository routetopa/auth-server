...
FOR %%x IN ("D:\Luca\Documents\Route to PA\routetopa-openid\inc\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\Luca\Documents\Route to PA\routetopa-openid\inc\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\Luca\Documents\Route to PA\routetopa-openid\inc"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\Wamp\bin\php\php5.5.12\php.exe"
